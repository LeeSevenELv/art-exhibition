...
@interface ShanghaiViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)creatRefreshView {
    ...
    [self.tableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        NSString *url=[NSString stringWithFormat:kShanghaiUrl,(long)weakSelf.pageIndex];
...
- (void)firstDownload {
    ...
    NSString *url = [NSString stringWithFormat:kShanghaiUrl,(long)self.pageIndex];
