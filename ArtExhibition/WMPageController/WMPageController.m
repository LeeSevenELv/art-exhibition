...
//    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"UINavigationBg.png"]];
   UIBarButtonItem *item=[[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"lover"] style:UIBarButtonItemStylePlain target:self action:@selector(set:)];
