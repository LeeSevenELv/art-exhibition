...
@interface HangzhouViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation HangzhouViewController
...
- (void)creatRefreshView {
    ...
    [self.tableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        NSString *url=[NSString stringWithFormat:kHangzhouUrl,(long)weakSelf.pageIndex];
...
- (void)firstDownload {
    ...
    NSString *url = [NSString stringWithFormat:kHangzhouUrl,(long)self.pageIndex];
...
- (void)addTaskWithUrl:(NSString *)url isRefresh:(BOOL)isRefresh {
    ...
    if ((isRefresh == NO)&&(isExist == YES)&&(isTimeout == NO) ) {
        ...
        [self.tableView reloadData];        //关闭特效
